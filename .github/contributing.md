# Contributing to rss-feed-to-json

First and foremost, thank you! We appreciate that you want to contribute to rss-feed-to-json, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for rss-feed-to-json**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for rss-feed-to-json:

- star the [project](https://github.com/HoukasaurusRex/rss-feed-to-json)
- tweet your support for rss-feed-to-json
...
- **version**: (required) please note the version of rss-feed-to-json are you using
...
The original poster or the maintainers of rss-feed-to-json may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/rss-feed-to-json
